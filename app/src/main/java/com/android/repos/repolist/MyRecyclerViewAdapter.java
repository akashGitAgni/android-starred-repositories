...
class MyRecyclerViewAdapter extends RealmRecyclerViewAdapter<Repository, MyRecyclerViewAdapter
        .MyViewHolder> {

    private boolean inDeletionMode = false;
    private Set<Integer> countersToDelete = new HashSet<Integer>();

    MyRecyclerViewAdapter(OrderedRealmCollection<Repository> data) {
        super(data, true);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        final Repository obj = getItem(position);
        holder.data = obj;
        //noinspection ConstantConditions
        holder.title.setText(obj.getFullName());
    }
